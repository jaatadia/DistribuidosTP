...
#define COLA_LOCKER_RESPUESTA_DEPOSITO 112
#define COLA_LOCKER_RESPUESTA_EXTRACCION 113

#define DESP 3
#define MUTEX_PUERTA_ESPERANDO 114 //para la puerta i es MUTEX_PUERTA_ESPERANDO + (i-1)*DESP
#define MUTEX_CONTADOR_COLAS_PUERTAS 115
#define CONTADOR_COLAS_PUERTAS 116
